...
const AdminCRM = () => {
  ...
  const [period, setPeriod]   = useState('monthly'); // today | weekly | monthly | yearly
  ...
  const cutoff = period === 'today' ? dayStart : period === 'weekly' ? weekStart : period === 'monthly' ? monthStart : yearStart;
                  ...
                  <table className="w-full text-xs">
                    ...
                    <tbody>
                      {periodLeads.map((l, i) => {
                        ...
                        }[l.status] || 'bg-gray-100 text-gray-500';
                        return (
                          <tr key={l._id} className={`border-b border-gray-50 hover:bg-violet-50/30 transition-colors ${i % 2 === 0 ? '' : 'bg-gray-50/30'}`}>
